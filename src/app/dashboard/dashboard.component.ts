...
import { TransactionMonthlyComponent } from "../layout/chart/transaction-monthly/transaction-monthly.component";
...
@Component({
  ...
  imports: [CommonModule,
    ...
    SidenavComponent,
    RouterOutlet,
    MatCardModule, MonthlyExpensesSummaryComponent, MonthlyIncomeSummaryComponent, TransactionMonthlyComponent, SavingProgressComponent, TopSpendingCategoriesComponent, BudgetVsSpendingComponent],
