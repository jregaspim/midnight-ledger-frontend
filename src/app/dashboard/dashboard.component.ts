...
@Component({
  ...
  imports: [CommonModule,
    ...
    SidenavComponent,
    RouterOutlet,
    MatCardModule, MonthlyExpensesSummaryComponent, MonthlyIncomeSummaryComponent, IncomeVsExpensesComponent, SavingProgressComponent, TopSpendingCategoriesComponent],
